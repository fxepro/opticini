  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-h2-dynamic font-bold">Collateral</h1>
          <p className="text-muted-foreground mt-1">Learning resources, documentation, and helpful materials for using Opticini</p>
        </div>
