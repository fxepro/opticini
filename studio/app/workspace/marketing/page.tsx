  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-h2-dynamic font-bold">Marketing & Deals</h1>
          <p className="text-muted-foreground mt-1">Manage promotional deals and featured offers</p>
        </div>
        <Button
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-2">
                      <CardTitle className="text-h3-dynamic">{deal.name}</CardTitle>
                      {deal.featured && (
